...
const alertVariants = cva(
  "relative w-full rounded-lg border px-4 py-3.5 text-sm [&>svg]:absolute [&>svg]:left-4 [&>svg]:top-4 [&>svg]:size-4 [&>svg~*]:pl-7",
  {
    variants: {
      variant: {
        ...
        warning:
          "border-amber-500/30 bg-amber-500/5 text-foreground [&>svg]:text-amber-500",
      },
    },
    defaultVariants: {
      variant: "default",
