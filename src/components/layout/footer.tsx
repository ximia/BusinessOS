...
/**
 * Footer. Accepts resolved Business Settings (defaults to compile-time config)
 * so it reflects live, admin-edited company details.
 */
export function Footer({ settings = siteConfig }: { settings?: SiteConfig }) {
  const site = settings;
      ...
      <div className="container py-16">
        <div className="grid gap-12 lg:grid-cols-[1.4fr_repeat(3,1fr)]">
          <div className="max-w-sm">
            <Logo name={site.companyName} src={site.logo.src} alt={site.logo.alt} />
